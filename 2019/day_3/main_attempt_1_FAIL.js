...
class AOC2019DayThree {
    ...
    getCoordinatesForWire(wire) {
        ...
        parsedWire.forEach((element, index) => {
            ...
            let coord;
            const prevCoord = coordsForWire.length > 0 ? coordsForWire[index - 1] : { x: 0, y: 0 };
            switch (direction) {
                case 'R':
    ...
    parsedWires$() {
        return this.reader.line$.pipe(operators_1.map(data => {
            let wire = { points: this.getCoordinatesForWire(data) };
            return wire;
...
self.run();
//# sourceMappingURL=main_attempt_1_FAIL.js.map